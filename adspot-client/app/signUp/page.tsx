/**
 * v0 by Vercel.
 * @see https://v0.dev/t/Jj5YyYduxQ6
    ...
    <div className="grid gap-6 lg:grid-cols-2 items-center justify-center min-h-[600px] px-4 py-6 space-y-4 text-center xl:min-h-[800px] bg-white dark:bg-orange-800">
      <div className="space-y-3">
        <div className="space-y-2">
          ...
          />
          <div className="space-y-2">
            <h1 className="text-3xl font-bold text-orange-900 dark:text-orange-400">Create an Account</h1>
          </div>
        </div>
        <div className="space-y-4">
          <div className="space-y-2">
            <Label className="text-orange-900 dark:text-orange-400" htmlFor="username">
              Username
            </Label>
            <Input className="bg-white dark:bg-gray-950" id="username" placeholder="Enter your username" required />
          </div>
          <div className="space-y-2">
            <Label className="text-orange-900 dark:text-orange-400" htmlFor="email">
              Email
            </Label>
            <Input className="bg-white dark:bg-gray-950" id="email" placeholder="m@example.com" required type="email" />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            <Label className="text-orange-900 dark:text-orange-400" htmlFor="confirm-password">
              Confirm Password
            </Label>
            <Input className="bg-white dark:bg-gray-950" id="confirm-password" required type="password" />
          </div>
